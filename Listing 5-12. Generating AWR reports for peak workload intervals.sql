-- This script generates an AWR report for the peak time over the past back_days (defaulted to 7 days).
...
BEGIN
    ...
    FOR instance_rec IN (SELECT instance_number, instance_name FROM gv$instance) LOOP
        ...
        DBMS_OUTPUT.PUT_LINE('AWR report written: /tmp/' || awr_file_name);
    END LOOP;
